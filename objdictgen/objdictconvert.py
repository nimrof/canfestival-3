...
#
#Based on objdictgen.py
#Copyright (C): Lars Elgtvedt Susaas
#
...
def usage():
    print ("\nUsage of "+os.path.basename(__file__)+" :")
    print "\n   %s objDictFileA objDictFileB\n"%sys.argv[0]
...
if __name__ == '__main__':
    if fileIn != "" and fileOut != "":
        ...
        result = manager.SaveCurrentInFile(fileOut)
